...
//    Literature Harvester
  private final static String QUEUE_NAME = "iasis.structured_analysis.queue";
  private final static String EXCHANGE_NAME = "iasis.direct";
  private final static String ROUTING_KEY = "iasis.structured_analysis.routingkey";
    /**
...
//        String message = "jobID 03";
//        byte[] message =  BigInteger.valueOf(2).toByteArray();
        JSONObject responce =  new JSONObject();
        responce.put("jobID",  new Integer(18)); 
